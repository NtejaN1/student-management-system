...
public class DatabaseManager {
    ...
    // ==================================================
// UPDATE – Update student information by Roll Number
// ==================================================
    ...
    try (BufferedReader reader =
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (s != null && s.getRollNo() == targetRoll) {
                ...
                char newGrade = sc.next().toUpperCase().charAt(0);
                sc.nextLine();

                Student updatedStudent =
                        new Student(targetRoll, newName, newGrade);

                writer.write(updatedStudent.toFileLine());
                writer.newLine();
